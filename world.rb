...
myroot = Node.root do
 ...
 the windows, the only light comes from a dim lamp
   in
 ...
 well-used couch, covered in blankets and pillows.
  ...
  item(:cat, 'cat', 'sleeping', 'fuzzy') do
   ...
   self.desc = <<-DESC
	A pumpkin-colored long-haired cat. He is well-groomed and certainly a house cat and seems perfectly
	content to sleep the day away on the couch.
   DESC
   self.short_desc = <<-DESC
